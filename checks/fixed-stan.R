...
fit_stan <- rstan::stan("stan/fixed-stan/check.stan",
...
fit_stan_01 <- rstan::stan("../stan/fixed-stan/check-01.stan",
...
fit_stan_02 <- rstan::stan("../stan/fixed-stan/check-02.stan",
...
fit_stan_02_bigger <- rstan::stan("../stan/fixed-stan/check-02.stan",
                                  data = list(n = nrow(sf), y = floor(sf$y), m = floor(sf$n_obs), mu = rep(0, nrow(sf)), K = cov),
                                  warmup = 100,
                                  iter = 10000)
